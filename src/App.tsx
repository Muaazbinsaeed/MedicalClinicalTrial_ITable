...
import { makeData, ClinicalTrialData } from './makeData'
...
export const App = () => {
  ...
  const [data, setData] = React.useState(ClinicalTrialData)
  const refreshData = () => setData(ClinicalTrialData)
  ...
  const table = useReactTable({
    ...
    // columnResizeMode: 'onChange',
    onColumnVisibilityChange: setColumnVisibility, // Column Select
  ...
  return (
    ...
    <Panel header="title2">this is panel content2 or other</Panel>
      ...
      <Collapse.Panel header="Column Selection" key="columnVisibilityPanel">
        <div className="p-2 inline-block border border-black shadow rounded">
          <div className="px-1 border-b border-black">
            <label>
              <input
